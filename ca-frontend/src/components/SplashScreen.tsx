      ...
      <div className="text-center relative z-10">
        ...
        <div className="mb-8 flex justify-center">
          <div className="w-24 h-24 bg-white rounded-3xl shadow-2xl flex items-center justify-center transform hover:scale-105 transition-transform">
            <span className="text-[#2A56FF]" style={{ fontSize: '42px', fontWeight: 700 }}>CA</span>
          </div>
        </div>
        
        <h1 className="text-white mb-3 animate-slide-down" style={{ fontSize: '42px' }}>Campus Arena</h1>
